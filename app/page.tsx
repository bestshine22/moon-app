    ...
    <main style={styles.page}>
      <div style={styles.container}>
        <header style={styles.header}>
          ...
          <p style={styles.subtitle}>حساب أفضل وقت لرؤية الهلال الجديد</p>
        </header>
        ...
        {best && (
          <>
            <h2 style={styles.bigHeading}>🔭 أفضل وقت للرصد بالعين المجردة</h2>
            ...
            <section style={{ ...styles.greenCard, borderColor: statusColor }}>
              ...
              <div style={styles.grid}>
                ...
                <Result label="الاتجاه بالبوصلة" value={`${best.azimuth}° - ${directionName(best.azimuth)}`} icon="🧭" green />
                <Result label="ارتفاع الهلال" value={`${best.altitude}°`} icon="△" green />
                <Result label="عمر الهلال" value={best.ageText} icon="☾" green />
                <Result label="الاستطالة" value={`${best.elongation}°`} icon="☼" green />
                <Result label="الإضاءة" value={`${best.illumination}%`} icon="🌙" green />
              </div>
            </section>
            ...
            <section style={styles.orangeCard}>
              ...
              <div style={styles.grid3}>
                ...
                <Result label="مكث القمر" value={`${result.best.lag} دقيقة`} icon="⌛" orange />
              </div>
            </section>
          </>
        )}
        ...
        {custom && (
          <section style={styles.blueCard}>
            ...
            <div style={styles.grid}>
              ...
              <Result label="الاتجاه بالبوصلة" value={`${custom.azimuth}° - ${directionName(custom.azimuth)}`} icon="🧭" blue />
