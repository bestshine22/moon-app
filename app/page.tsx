      ...
      <div style={styles.container}>
        <header style={styles.header}>
          ...
          <p style={styles.subtitle}>
            حسابات فلكية دقيقة للهلال حسب الموقع والوقت
          </p>
        </header>
        ...
        {best && (
          <>
            <h2 style={styles.bigHeading}>
              🔭 أفضل وقت حسابي للرصد
            </h2>

            <section style={styles.greenCard}>
              <div style={styles.grid}>
                <Result
                  label="الإحداثيات DMS"
                  value={`${decimalToDMS(lat, "lat")} | ${decimalToDMS(
                    lng,
                    "lng"
                  )}`}
                  icon="📍"
            ...
            <section style={styles.orangeCard}>
              ...
              <div style={styles.grid3}>
                <Result
                  label="غروب الشمس"
                  value={fmtTime(result.best.sunsetIso)}
                  icon="🌇"
                  orange
                />
                ...
                <Result
                  label="غروب القمر"
                  value={fmtTime(result.best.moonsetIso)}
                  icon="🌙"
                  orange
                />
        ...
        <div style={styles.note}>
          ℹ️ هذه الصفحة تعرض الحسابات الفلكية فقط.
        </div>
      </div>
    </main>
  );
