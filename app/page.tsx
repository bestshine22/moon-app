    ...
    <main style={styles.page}>
      <div style={styles.container}>
        <header style={styles.header}>
          ...
          <p style={styles.subtitle}>حسابات فلكية دقيقة للهلال حسب الموقع والوقت</p>
        </header>
        ...
        <div style={styles.note}>
          ℹ️ هذه الصفحة تعرض الحسابات الفلكية فقط. حكم الرؤية ومعيار عودة نضيفه بعد تثبيت دقة الأرقام.
        </div>
      </div>
    </main>
  );
